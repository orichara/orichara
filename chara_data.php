...
while (true) {
    ...
    print <<< ETSURAN
	<tr>
	<td><a href="https://angry-ori-chara.ssl-lolipop.jp/chara_data.php?code=$rival_code">$taisenn_aite</a></td>
	<td>$syousya</td>
	<td>$date</td>
	<td>$end_turn</td>
	</tr>
...
while (true) {
    ...
    print <<< ETSURAN
	<tr>
	<td><a href="https://angry-ori-chara.ssl-lolipop.jp/chara_data.php?code=$code2">$taisenn_aite</a></td>
	<td>$syousya</td>
	<td>$date</td>
	<td>$end_turn</td>
	</tr>
