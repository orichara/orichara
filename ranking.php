...
<div class="container col-12" id="container">
	...
	<div class="row">
		...
		<div class="col-xs-12 btn-group mx-auto" role="group" aria-label="Basic example" class="text-center">
			<button type="button" class="btn btn-secondary" ><a href="http://ori-chara.angry.jp/ranking.php?rank=1">レベル</a></button>
			<button type="button" class="btn btn-secondary" ><a href="http://ori-chara.angry.jp/ranking.php?rank=2">攻撃力</a></button>
			<button type="button" class="btn btn-secondary" ><a href="http://ori-chara.angry.jp/ranking.php?rank=3">防御力</a></button>
			<button type="button" class="btn btn-secondary" ><a href="http://ori-chara.angry.jp/ranking.php?rank=4">素早さ</a></button>
			<button type="button" class="btn btn-secondary" ><a href="http://ori-chara.angry.jp/ranking.php?rank=5">HP</a></button>
			<button type="button" class="btn btn-secondary" ><a href="http://ori-chara.angry.jp/ranking.php?rank=6">対戦数</a></button>
			<button type="button" class="btn btn-secondary" ><a href="http://ori-chara.angry.jp/ranking.php?rank=7">最大ダメージ</a></button>
			<button type="button" class="btn btn-secondary" ><a href="http://ori-chara.angry.jp/ranking.php?rank=8">回避数</a></button>
			<button type="button" class="btn btn-secondary" ><a href="http://ori-chara.angry.jp/ranking.php?rank=9">長期戦</a></button>
		</div>
