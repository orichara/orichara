...
<form method="GET" action="chara_serch.php">
  <div class="form-group">
	<input class="form-control" placeholder="検索するオリキャラの名前を入力してください" name="word" value="<?php if( !empty($_GET['word']) ){ echo $_GET['word']; } ?>">
    <small id="emailHelp" class="form-text text-muted">キャラクター名を入力し、検索ボタンを押してください。部分一致も可。</small>
  </div>
