...
<body>
	...
	<div class="col-12 boxB">
		...
		<table class="table-striped" border="1" width="100%" style="table-layout: auto;">
			<tr>
				<th bgcolor="#b0b0b0">
					<font color="#FFFFFF">挑戦者</font>
				</th>
				<th bgcolor="#b0b0b0">
					<font color="#FFFFFF">対戦相手</font>
				</th>
				<th bgcolor="#b0b0b0">
					<font color="#FFFFFF">勝者</font>
				</th>
				<th bgcolor="#b0b0b0">
					<font color="#FFFFFF">対戦日時</font>
				</th>
				<th bgcolor="#b0b0b0">
					<font color="#FFFFFF">終了ターン</font>
				</th>
				<th bgcolor="#b0b0b0">
					<font color="#FFFFFF">最大与ダメージ</font>
				</th>
				<th bgcolor="#b0b0b0">
					<font color="#FFFFFF">最大被ダメージ</font>
				</th>
				<th bgcolor="#b0b0b0">
					<font color="#FFFFFF">攻撃をかわした数</font>
				</th>
				<th bgcolor="#b0b0b0">
					<font color="#FFFFFF">攻撃をかわされた数</font>
				</th>
			</tr>
